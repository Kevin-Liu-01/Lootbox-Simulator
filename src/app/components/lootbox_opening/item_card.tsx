...
import { rarityColors, type Rarity } from "~/app/utils/types";
    ...
    >
      ...
      <Flex justify="center" className="relative sm:w-full">
        <img
          src={item?.image}
          alt={item.name}
          className="h-32 w-32 rounded-xl bg-gradient-to-br from-black/30 to-black/20 object-contain p-2 shadow-lg sm:w-full sm:rounded-lg"
        />
        {/* Rarity Badge */}
        <div
